...
const routes: Routes = [
    ...
    { path: 'search-experiment', loadChildren: () => import('./search-experiment/search-experiment.module').then(m => m.SearchExperimentModule) },
    ...
    { path: 'guideline-datalab', loadChildren: () => import('./guidelineDataLab/guidelineDataLab.module').then(m => m.GuidelineDataLabModule) },
    { path: 'data-visualization', loadChildren: () => import('./data-visualization/data-visualization.module').then(m => m.DataVisualizationModule) },
    { path: 'mb-dashboard', loadChildren: () => import('./mb-dashboard/mb-dashboard.module').then(m => m.MBDashboardModule) },
    { path: 'pubScreen-dashboard', loadChildren: () => import('./pubScreen-dashboard/pubScreen-dashboard.module').then(m => m.PSDashboardModule) },

// from https://stackoverflow.com/questions/46593689/window-scrollto0-0-and-scrolltop-0-not-working-on-angular-2-route-changes
...
export class ScrollService {
  ...
  get topOfPageElement() {
    if (!this._topOfPageElement) {
      this._topOfPageElement = this.document.getElementById('contentMain') || this.document.body;
    }

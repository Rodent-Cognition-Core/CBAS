...
import { FIELDISREQUIRED, INVALIDEMAILADDRESS, PIALRADYEXISTS, PISUCCESSFULLYADDED } from '../shared/messages';
...
export class CogbytesPIDialogeComponent implements OnInit {
    ...
    getErrorMessagePIEmailValid() {
        ...
        return this.emailPI.hasError('pattern') ? FIELDISREQUIRED :
            '';
    }

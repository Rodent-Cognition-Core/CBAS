    ...
    public class PubScreenService
    {
        ...
        public async Task<PubScreenSearch> GetDataFromPubScreenByLinkGuid(Guid paperLinkGuid)
        {
            ...
            var publications = await Dal.GetReaderPubAsync(sql, reader => new PubScreenSearch
            {
                ...
                Author = Convert.ToString(reader.GetValue(reader.GetOrdinal("Author")).ToString()),
                PaperType = Convert.ToString(reader.GetValue(reader.GetOrdinal("PaperType")).ToString()),
                Task = Convert.ToString(reader.GetValue(reader.GetOrdinal("Task")).ToString()),
                SubTask = Convert.ToString(reader.GetValue(reader.GetOrdinal("SubTask")).ToString()),
                Species = Convert.ToString(reader.GetValue(reader.GetOrdinal("Species")).ToString()),
                Sex = Convert.ToString(reader.GetValue(reader.GetOrdinal("Sex")).ToString()),
                Strain = Convert.ToString(reader.GetValue(reader.GetOrdinal("Strain")).ToString()),
                DiseaseModel = Convert.ToString(reader.GetValue(reader.GetOrdinal("DiseaseModel")).ToString()),
                SubModel = Convert.ToString(reader.GetValue(reader.GetOrdinal("SubModel")).ToString()),
                BrainRegion = Convert.ToString(reader.GetValue(reader.GetOrdinal("BrainRegion")).ToString()),
                SubRegion = Convert.ToString(reader.GetValue(reader.GetOrdinal("SubRegion")).ToString()),
                CellType = Convert.ToString(reader.GetValue(reader.GetOrdinal("CellType")).ToString()),
                Method = Convert.ToString(reader.GetValue(reader.GetOrdinal("Method")).ToString()),
                SubMethod = Convert.ToString(reader.GetValue(reader.GetOrdinal("SubMethod")).ToString()),
                NeuroTransmitter = Convert.ToString(reader.GetValue(reader.GetOrdinal("NeuroTransmitter")).ToString())
            }, parameters);
